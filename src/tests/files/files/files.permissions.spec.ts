...
test.describe("POST /api/2.0/files/logos - access control", () => {
  ...
  test.fail(
    "BUG XXXXX: POST /api/2.0/files/logos - DocSpaceAdmin can upload logo image",
    async ({ apiSdk }) => {
  ...
  test.fail(
    "BUG XXXXX: POST /api/2.0/files/logos - RoomAdmin can upload logo image",
    async ({ apiSdk }) => {
  ...
  test.fail(
    "BUG XXXXX: POST /api/2.0/files/logos - User can upload logo image",
    async ({ apiSdk }) => {
  ...
  test.fail(
    "BUG XXXXX: POST /api/2.0/files/logos - Guest cannot upload logo image",
    async ({ apiSdk }) => {
...
test.describe("GET /files/rooms/covers - access control", () => {
  ...
  test.fail(
    "BUG XXXXX: GET /files/rooms/covers - DocSpaceAdmin can get covers list",
    async ({ apiSdk }) => {
      await apiSdk.addMember("owner", "DocSpaceAdmin");
      const { data, status } = await apiSdk
  ...
  test.fail(
    "BUG XXXXX: GET /files/rooms/covers - RoomAdmin can get covers list",
    async ({ apiSdk }) => {
      await apiSdk.addMember("owner", "RoomAdmin");
      const { data, status } = await apiSdk
        .forRole("roomAdmin")
  ...
  test.fail(
    "BUG XXXXX: GET /files/rooms/covers - User can get covers list",
    async ({ apiSdk }) => {
      await apiSdk.addMember("owner", "User");
      const { data, status } = await apiSdk
        .forRole("user")
...
test.describe("PUT /files/rooms/:id/cover - access control", () => {
  ...
  test.fail(
    "BUG XXXXX: PUT /files/rooms/:id/cover - DocSpaceAdmin can change room cover",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: coversData } = await ownerApi.rooms.getRoomCovers();
      const coverId = coversData.response![0].id!;
  ...
  test.fail(
    "BUG XXXXX: PUT /files/rooms/:id/cover - RoomAdmin cannot change room cover",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: coversData } = await ownerApi.rooms.getRoomCovers();
      const coverId = coversData.response![0].id!;
  ...
  test.fail(
    "BUG XXXXX: PUT /files/rooms/:id/cover - User cannot change room cover",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: coversData } = await ownerApi.rooms.getRoomCovers();
      const coverId = coversData.response![0].id!;
  ...
  test.fail(
    "BUG XXXXX: PUT /files/rooms/:id/cover - Guest cannot change room cover",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: coversData } = await ownerApi.rooms.getRoomCovers();
      const coverId = coversData.response![0].id!;
...
test.describe("POST /files/rooms/:id/logo - access control", () => {
  ...
  test.fail(
    "BUG XXXXX: POST /files/rooms/:id/logo - DocSpaceAdmin can create room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: POST /files/rooms/:id/logo - RoomAdmin cannot create room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: POST /files/rooms/:id/logo - User cannot create room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: POST /files/rooms/:id/logo - Guest cannot create room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
...
test.describe("DELETE /files/rooms/:id/logo - access control", () => {
  ...
  test.fail(
    "BUG XXXXX: DELETE /files/rooms/:id/logo - DocSpaceAdmin can delete room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: DELETE /files/rooms/:id/logo - RoomAdmin cannot delete room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: DELETE /files/rooms/:id/logo - User cannot delete room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
  ...
  test.fail(
    "BUG XXXXX: DELETE /files/rooms/:id/logo - Guest cannot delete room logo",
    async ({ apiSdk }) => {
      const ownerApi = apiSdk.forRole("owner");
      const { data: roomData } = await ownerApi.rooms.createRoom({
        createRoomRequestDto: {
