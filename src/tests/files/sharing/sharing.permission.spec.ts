...
test.describe("GET /api/2.0/files/file/{fileId}/group/{groupId}/share", () => {
  ...
  test.fail("BUG XXXXX: GET /api/2.0/files/file/{fileId}/group/{groupId}/share - Guest gets full group member info when file is shared with guest and group", async ({
    apiSdk,
  }) => {
    const ownerApi = apiSdk.forRole("owner");
