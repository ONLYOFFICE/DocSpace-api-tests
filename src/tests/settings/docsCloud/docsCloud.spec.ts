...
test.describe("GET /api/2.0/settings/docscloud/tenant/info - negative", () => {
  test("BUG 83321: GET /api/2.0/settings/docscloud/tenant/info - returns 500 instead of 400 when DocsCloud tenant is not activated", async ({
    apiSdk,
  }) => {
    const { data, status } = await apiSdk
      .forRole("owner")
...
test.describe("PUT /api/2.0/settings/docscloud/tenant/config - string length validation", () => {
  test("BUG 83327: PUT /api/2.0/settings/docscloud/tenant/config - tenantName is not validated for length", async ({
    ...
    expect(status).toBe(400);
    expect((data as any).response?.errors?.TenantName).toEqual([
      "The field TenantName must be a string with a maximum length of 255.",
    ]);
  });
  ...
  test("BUG 83327: PUT /api/2.0/settings/docscloud/tenant/config - ipFilter.rules[].address is not validated for length", async ({
    ...
    expect(status).toBe(400);
    expect(
      (data as any).response?.errors?.["IpFilter.Rules[0].Address"],
    ).toEqual([
...
test.describe("GET /api/2.0/settings/docscloud/tenant/usage - negative", () => {
  test("BUG 83322: GET /api/2.0/settings/docscloud/tenant/usage - returns 500 instead of 400 when DocsCloud tenant is not activated", async ({
    apiSdk,
  }) => {
    const { data, status } = await apiSdk
      .forRole("owner")
...
test.describe("GET /api/2.0/settings/docscloud/tenant/quota - negative", () => {
  test("BUG 83325: GET /api/2.0/settings/docscloud/tenant/quota - returns 500 instead of 400 when DocsCloud tenant is not activated", async ({
    apiSdk,
  }) => {
    const { data, status } = await apiSdk
      .forRole("owner")
...
test.describe("GET /api/2.0/settings/docscloud/tenant/config - negative", () => {
  test("BUG 83320: GET /api/2.0/settings/docscloud/tenant/config - returns 500 instead of 400 when DocsCloud tenant is not activated", async ({
    apiSdk,
  }) => {
    const { data, status } = await apiSdk
      .forRole("owner")
...
test.describe("PUT /api/2.0/settings/docscloud/tenant/config - negative", () => {
  test("BUG 83323: PUT /api/2.0/settings/docscloud/tenant/config - returns 500 instead of 400 when DocsCloud tenant is not activated", async ({
    apiSdk,
  }) => {
    const { data, status } = await apiSdk
      .forRole("owner")
