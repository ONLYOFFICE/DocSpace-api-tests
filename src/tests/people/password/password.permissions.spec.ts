...
test.describe("POST /people/password - access control", () => {
  ...
  test("BUG 80157: POST /people/password - DocSpace admin reminds the docspace admin of the password.", async ({
    ...
    const { data } = await adminApi.password.sendUserPassword({ emailMemberRequestDto: { email } });
  ...
  test("POST /people/password - Room admin reminds the room admin of the password.", async ({
    ...
    const { data } = await roomAdminApi.password.sendUserPassword({ emailMemberRequestDto: { email } });
  ...
  test("POST /people/password - User reminds the user of the password.", async ({
    ...
    const { data } = await userApi.password.sendUserPassword({ emailMemberRequestDto: { email } });
  ...
  test("POST /people/password - Guest reminds the guest of the password.", async ({
    ...
    const { data } = await guestApi.password.sendUserPassword({ emailMemberRequestDto: { email } });
